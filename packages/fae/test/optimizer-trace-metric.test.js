...
`);
  t.is(traceEditDistance(observed.toolCalls, timestampExample.acceptableTraces[0]), 1);
  t.is(traceEditDistance(observed.toolCalls, timestampExample.acceptableTraces[1]), 0);
});
