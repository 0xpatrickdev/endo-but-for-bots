...
| [daemon-mount-capabilities](daemon-mount-capabilities.md) | 2026-05-18 | 2026-05-21 | **Complete** |
...
| daemon-mount-capabilities | **Complete** | `EndoMount` snapshot bridge, mount-scoped descriptors, `makeFile` sibling, entry overloads on `has`/`stat`/`lookup`, trusted backing provenance |
